                    ...
                    <div class="main-content">
                        ...
                        <div class="content-block">
                            <section id="TopTitres">
                                ...
                                <div id="div-top-titres-1" class="artiste-wrapper">
                                    <div class="artiste-row glass with-dots">
                                        <div class="infos">
                                            <div class="container-cover">
                                                <img id="top-titres-cover-1" src="" alt="cover">
                                            </div>
                                            <div class="texts">
                                                <h4 id="top-titres-album-1"></h4>
                                                <h5 id="top-titres-artiste-1"></h5>
                                            </div>
                                        </div>
                                        <div class="actions">
                                ...
                                <div id="div-top-titres-2" class="artiste-wrapper">
                                    <div class="artiste-row glass with-dots">
                                        <div class="infos">
                                            <div class="container-cover">
                                                <img id="top-titres-cover-2" src="" alt="cover">
                                            </div>
                                            <div class="texts">
                                                <h4 id="top-titres-album-2"></h4>
                                                <h5 id="top-titres-artiste-2"></h5>
                                            </div>
                                        </div>
                                        <div class="actions">
                                        <img class="menu-dots" src="./Assets/icons/menu-dots.svg" alt="open menu"/>
                                ...
                                <div id="div-top-titres-3" class="artiste-wrapper">
                                    <div class="artiste-row glass with-dots">
                                        <div class="infos">
                                            <div class="container-cover">
                                                <img id="top-titres-cover-3" src="" alt="cover">
                                            </div>
                                            <div class="texts">
                                                <h4 id="top-titres-album-3"></h4>
                                                <h5 id="top-titres-artiste-3"></h5>
                                            </div>
                                        </div>
                                        <div class="actions">
                                        <img class="menu-dots" src="./Assets/icons/menu-dots.svg" alt="open menu"/>
                                ...
                                <div id="div-top-titres-4" class="artiste-wrapper">
                                    <div class="artiste-row glass with-dots">
                                        <div class="infos">
                                            <div class="container-cover">
                                                <img id="top-titres-cover-4" src="" alt="cover">
                                            </div>
                                            <div class="texts">
                                                <h4 id="top-titres-album-4"></h4>
                                                <h5 id="top-titres-artiste-4"></h5>
                                            </div>
                                        </div>
                                        <div class="actions">
                                        <img class="menu-dots" src="./Assets/icons/menu-dots.svg" alt="open menu"/>
                                ...
                                <div id="div-top-titres-5" class="artiste-wrapper">
                                    <div class="artiste-row glass with-dots">
                                        <div class="infos">
                                            <div class="container-cover">
                                                <img id="top-titres-cover-5" src="" alt="cover">
                                            </div>
                                            <div class="texts">
                                                <h4 id="top-titres-album-5"></h4>
                                                <h5 id="top-titres-artiste-5"></h5>
                                            </div>
                                        </div>
                                        <div class="actions">
                                        <img class="menu-dots" src="./Assets/icons/menu-dots.svg" alt="open menu"/>
