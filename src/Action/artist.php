...
<div style="display: flex; flex-wrap: nowrap;">
    <div>
        ...
        <button class="playArtist" name="play" id="play" data-id-artiste="<?= $artist->getId() ?>">
            Play
        </button>
        ...
        <div>
            ...
            ?>
                <button class="topSon" type="submit" data-id-song="<?= $son->getId() ?>">
            ...
            ?>
                <div class="album">
                    ...
                    <?php endif; ?>
                    <button name="play" class="playAlbum" data-id-album="<?= $album->getId() ?>">
                        Play
                    </button>
                </div>
            <?php endforeach; ?>
    ...
    <div>
        ...
        <p id="nom-song"></p>
        <p id="nom-artist"></p>
        <img id="cover" src="" alt="Photo de l'album">
        <div style="display: flex; gap:25px;">
            <p id="time0"></p>
            <input type="range" id="slider" value="0" max="100" style="width: 80%; margin-top: 20px; display: none;">
            <p id="time1"></p>
        </div>

        <div>
            <button id="nextL">Next-l</button>
            <button id="pause">Pause</button>
            <button id="nextR">Next-r</button>
        </div>
